    ...
    <div className="pb-12">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 items-start">
        <div className="space-y-8 min-w-0">
          <div className="p-6 sm:p-8 rounded-3xl relative overflow-hidden bg-[#FCEFD9] shadow shadow-gray-400/20">
            <div className="space-y-2 z-10 max-w-md">
              <h2 className="text-2xl sm:text-4xl font-bold font-display text-foreground/90 tracking-tight leading-tight">
        ...
        <aside className="hidden lg:block lg:sticky lg:top-10 lg:h-[calc(100vh-5rem)] shrink-0 w-full p-6 rounded-3xl bg-card border border-border/80 shadow-xs">
          <div className="w-full">
            <p className="text-lg font-bold font-display text-foreground tracking-tight mb-2">Daily Reminder</p>
            <Image src="/images/sun_illustration.png" alt="daily_reminder" width={1536} height={1024} className="w-full h-auto select-none pointer-events-none" />
            <p className="text-base font-semibold font-body text-foreground tracking-tight text-center px-10">Every page you read today builds a better you tomorrow.</p>
          </div>
        </aside>
      </div>
    </div>
